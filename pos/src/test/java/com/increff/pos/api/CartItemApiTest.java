...
public class CartItemApiTest extends AbstractUnitTest {
    ...
    public void testAddCartItem() throws ApiException {
        ...
        List<CartItemPojo> cartItemPojoList =  cartItemApi.getAllItemsInCart(counterId);
    ...
    public void testSizeOfCartList() throws ApiException {
        ...
        cartItemPojoList =  cartItemApi.getAllItemsInCart(counterId);
    ...
    public void testDeleteCartItem() throws ApiException {
        ...
        List<CartItemPojo> newCartItemPojoList =  cartItemApi.getAllItemsInCart(counterId);
    ...
    public void updateCartItem() throws ApiException {
        ...
        CartItemPojo updatedCartItemPojo = PojoUtil.getCartPojo(productId,counterId,newSellingPrice,newQuantity);
    ...
    public void testCartQuantityWithInventoryQuantity() throws ApiException {
        ...
        CartItemPojo newCartItemPojo = PojoUtil.getCartPojo(productId,counterId,sellingPrice,quantity+1);
